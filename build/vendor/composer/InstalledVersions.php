 ...
 */
namespace WPPedia\Container\Composer;

use WPPedia\Container\Composer\Autoload\ClassLoader;
use WPPedia\Container\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WPPedia\\Container\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
