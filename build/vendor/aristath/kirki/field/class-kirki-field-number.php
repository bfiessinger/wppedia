...
class Kirki_Field_Number extends Kirki_Field
{
    ...
    {
        $this->choices = wp_parse_args($this->choices, array('min' => -999999999, 'max' => 999999999, 'step' => 1));
 ...
 * Field overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Field_Number', 'Kirki_Field_Number', \false);
