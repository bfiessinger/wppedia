...
class Kirki_Field_Code extends Kirki_Field
{
    ...
    protected function set_choices()
    {
        ...
        if ('text/x-scss' === $this->editor_settings['codemirror']['mode']) {
            $this->editor_settings['codemirror'] = \array_merge($this->editor_settings['codemirror'], array('lint' => \false, 'autoCloseBrackets' => \true, 'matchBrackets' => \true));
        }
    }
    /**
 ...
 * Field overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Field_Code', 'Kirki_Field_Code', \false);
