...
if (!\class_exists('WPPedia\\Container\\ariColor')) {
    /**
    ...
    class ariColor
    {
        ...
        {
            if (\in_array($property, array('red', 'green', 'blue', 'alpha'), \true)) {
            ...
            } elseif (\in_array($property, array('hue', 'saturation', 'lightness'), \true)) {
        ...
        public function get_mode($color)
        {
            ...
            if (\is_array($color)) {
                ...
                $finders_keepers = array('r' => 'red', 'g' => 'green', 'b' => 'blue', 'a' => 'alpha', 'red' => 'red', 'green' => 'green', 'blue' => 'blue', 'alpha' => 'alpha', 'opacity' => 'alpha');
                $found = \false;
            ...
            $finders_keepers = array('#' => 'hex', 'rgba' => 'rgba', 'rgb' => 'rgb', 'hsla' => 'hsla', 'hsl' => 'hsl');
            foreach ($finders_keepers as $finder => $keeper) {
        ...
        {
            if (!\function_exists('WPPedia\\Container\\sanitize_hex_color')) {
        ...
        {
            $this->brightness = array('red' => \round($this->red * 0.299), 'green' => \round($this->green * 0.587), 'blue' => \round($this->blue * 0.114), 'total' => \intval($this->red * 0.299 + $this->green * 0.587 + $this->blue * 0.114));
        }
        /**
        ...
        {
            $lum = 0.2126 * $this->red + 0.7151999999999999 * $this->green + 0.0722 * $this->blue;
