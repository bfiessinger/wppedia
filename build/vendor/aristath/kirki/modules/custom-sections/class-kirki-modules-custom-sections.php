...
class Kirki_Modules_Custom_Sections
{
    ...
    {
        $new_types = array('kirki-default' => 'Kirki_Sections_Default_Section', 'kirki-expanded' => 'Kirki_Sections_Expanded_Section', 'kirki-nested' => 'Kirki_Sections_Nested_Section', 'kirki-link' => 'Kirki_Sections_Link_Section');
    ...
    {
        $new_types = array('kirki-nested' => 'Kirki_Panels_Nested_Panel');
 ...
 * Adds styles to the customizer.
 */
\class_alias('WPPedia\\Container\\Kirki_Modules_Custom_Sections', 'Kirki_Modules_Custom_Sections', \false);
