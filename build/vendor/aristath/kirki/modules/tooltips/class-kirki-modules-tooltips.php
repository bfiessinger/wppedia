...
class Kirki_Modules_Tooltips
{
    ...
    private function parse_fields()
    {
        ...
        foreach ($fields as $field) {
            if (isset($field['tooltip']) && !empty($field['tooltip'])) {
                ...
                $this->tooltips_content[$id] = array('id' => $id, 'content' => $field['tooltip']);
            }
        }
    }
    /**
    ...
    {
        $this->tooltips_content[$field_id] = array('id' => sanitize_key($field_id), 'content' => wp_kses_post($tooltip));
    }
    /**
     * Enqueue scripts.
     *
 ...
 * Adds script for tooltips.
 */
\class_alias('WPPedia\\Container\\Kirki_Modules_Tooltips', 'Kirki_Modules_Tooltips', \false);
