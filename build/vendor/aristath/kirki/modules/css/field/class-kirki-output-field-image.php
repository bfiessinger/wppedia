...
class Kirki_Output_Field_Image extends Kirki_Output
{
    ...
    protected function process_output($output, $value)
    {
        ...
        $output = wp_parse_args($output, array('media_query' => 'global', 'prefix' => '', 'units' => '', 'suffix' => ''));
        if (\is_array($value)) {
 ...
 * Output overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Output_Field_Image', 'Kirki_Output_Field_Image', \false);
