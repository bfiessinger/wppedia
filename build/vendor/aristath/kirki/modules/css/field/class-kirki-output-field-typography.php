...
class Kirki_Output_Field_Typography extends Kirki_Output
{
    ...
    protected function process_output($output, $value)
    {
        ...
        $properties = array('font-family', 'font-size', 'variant', 'font-weight', 'font-style', 'letter-spacing', 'word-spacing', 'line-height', 'text-align', 'text-transform', 'text-decoration', 'color');
        foreach ($properties as $property) {
            ...
            if ('variant' === $property && isset($value['variant']) && !empty($value['variant'])) {
                ...
                $font_weight = \in_array($font_weight, array('', 'regular'), \true) ? '400' : $font_weight;
                // Is this italic?
            ...
            if ('font-family' === $property) {
                ...
                $property_value = $this->process_property_value($property, array($value['font-family'], $value['font-backup']));
            }
 ...
 * Output overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Output_Field_Typography', 'Kirki_Output_Field_Typography', \false);
