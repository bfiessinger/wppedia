...
class Kirki_Output_Field_Background extends Kirki_Output
{
    ...
    {
        $output = wp_parse_args($output, array('media_query' => 'global', 'element' => 'body', 'prefix' => '', 'suffix' => ''));
 ...
 * Output overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Output_Field_Background', 'Kirki_Output_Field_Background', \false);
