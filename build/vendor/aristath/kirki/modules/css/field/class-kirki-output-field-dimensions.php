...
class Kirki_Output_Field_Dimensions extends Kirki_Output
{
    ...
    {
        $output = wp_parse_args($output, array('element' => '', 'property' => '', 'media_query' => 'global', 'prefix' => '', 'suffix' => ''));
        if (!\is_array($value)) {
            return;
        }
 ...
 * Output overrides.
 */
\class_alias('WPPedia\\Container\\Kirki_Output_Field_Dimensions', 'Kirki_Output_Field_Dimensions', \false);
