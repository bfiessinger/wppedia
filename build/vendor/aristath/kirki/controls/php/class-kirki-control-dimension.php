...
class Kirki_Control_Dimension extends Kirki_Control_Base
{
    ...
    {
        parent::enqueue();
        wp_localize_script('kirki-script', 'dimensionkirkiL10n', array('invalid-value' => esc_html__('Invalid Value', 'kirki')));
    }
    /**
 ...
 * A text control with validation for CSS units.
 */
\class_alias('WPPedia\\Container\\Kirki_Control_Dimension', 'Kirki_Control_Dimension', \false);
