...
class Kirki_Control_Slider extends Kirki_Control_Base
{
    ...
    {
        parent::to_json();
        $this->json['choices'] = wp_parse_args($this->json['choices'], array('min' => '0', 'max' => '100', 'step' => '1', 'suffix' => ''));
    }
    /**
    ...
    protected function content_template()
    {
		...
		<label>
			...
			<div class="wrapper">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span class="screen-reader-text"><?php 
        esc_html_e('Reset', 'kirki');
        ?></span></span>
				<span class="value">
 ...
 * Slider control (range).
 */
\class_alias('WPPedia\\Container\\Kirki_Control_Slider', 'Kirki_Control_Slider', \false);
