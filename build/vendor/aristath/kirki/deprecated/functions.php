...
if (!\function_exists('WPPedia\\Container\\kirki_get_option')) {
    /**
...
if (!\function_exists('WPPedia\\Container\\kirki_sanitize_hex')) {
...
if (!\function_exists('WPPedia\\Container\\kirki_get_rgb')) {
...
if (!\function_exists('WPPedia\\Container\\kirki_get_rgba')) {
...
if (!\function_exists('WPPedia\\Container\\kirki_get_brightness')) {
...
if (!\function_exists('WPPedia\\Container\\Kirki')) {
    function Kirki()
    {
        return kirki();
    }
