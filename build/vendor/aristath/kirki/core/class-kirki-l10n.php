...
class Kirki_L10n
{
    ...
    {
        return array(\WP_LANG_DIR . '/' . $this->textdomain . '-' . get_locale() . '.mo', Kirki::$path . '/languages/' . $this->textdomain . '-' . get_locale() . '.mo');
    }
    /**
 ...
 * Handles translations
 */
\class_alias('WPPedia\\Container\\Kirki_L10n', 'Kirki_L10n', \false);
