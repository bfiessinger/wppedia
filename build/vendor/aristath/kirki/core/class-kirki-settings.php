...
class Kirki_Settings
{
    ...
    {
        $this->wp_customize->add_setting(new $classname($this->wp_customize, $setting, array('default' => $default, 'type' => $type, 'capability' => $capability, 'transport' => $transport, 'sanitize_callback' => $sanitize_callback)));
    }
    /**
    ...
    private function set_setting_types()
    {
        ...
        $this->setting_types = apply_filters('kirki_setting_types', array('default' => 'WP_Customize_Setting', 'repeater' => 'Kirki_Settings_Repeater_Setting', 'user_meta' => 'Kirki_Setting_User_Meta', 'site_option' => 'Kirki_Setting_Site_Option'));
 ...
 * Each setting is a separate instance
 */
\class_alias('WPPedia\\Container\\Kirki_Settings', 'Kirki_Settings', \false);
