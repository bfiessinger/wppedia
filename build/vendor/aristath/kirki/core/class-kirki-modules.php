...
class Kirki_Modules
{
    ...
    {
        self::$modules = apply_filters('kirki_modules', array('css' => 'Kirki_Modules_CSS', 'css-vars' => 'Kirki_Modules_CSS_Vars', 'icons' => 'Kirki_Modules_Icons', 'loading' => 'Kirki_Modules_Loading', 'tooltips' => 'Kirki_Modules_Tooltips', 'postMessage' => 'Kirki_Modules_PostMessage', 'selective-refresh' => 'Kirki_Modules_Selective_Refresh', 'field-dependencies' => 'Kirki_Modules_Field_Dependencies', 'custom-sections' => 'Kirki_Modules_Custom_Sections', 'webfonts' => 'Kirki_Modules_Webfonts', 'webfont-loader' => 'Kirki_Modules_Webfont_Loader', 'preset' => 'Kirki_Modules_Preset', 'gutenberg' => 'Kirki_Modules_Gutenberg'));
    }
    /**
    ...
    {
        if (!\in_array($module, self::$modules, \true)) {
            self::$modules[] = $module;
        }
    }
    /**
    ...
    {
        $key = \array_search($module, self::$modules, \true);
        if (\false !== $key) {
 ...
 * The Kirki_Modules class.
 */
\class_alias('WPPedia\\Container\\Kirki_Modules', 'Kirki_Modules', \false);
