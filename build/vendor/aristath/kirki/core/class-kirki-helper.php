...
class Kirki_Helper
{
    ...
    {
        if (\is_string($args)) {
            $args = add_query_arg(array('suppress_filters' => \false));
    ...
    public static function get_taxonomies()
    {
        $items = array();
        // Get the taxonomies.
        $taxonomies = get_taxonomies(array('public' => \true));
        // Build the array.
    ...
    public static function get_post_types()
    {
        $items = array();
        // Get the post types.
        $post_types = get_post_types(array('public' => \true), 'objects');
        // Build the array.
 ...
 * A simple object containing static methods.
 */
\class_alias('WPPedia\\Container\\Kirki_Helper', 'Kirki_Helper', \false);
