...
class Attachment
{
    ...
    {
        return (string) get_post_meta($attachment_id, '_wp_attachment_image_alt', \true);
    }
    /**
    ...
    public static function get_by_url($url)
    {
        ...
        $id = \function_exists('WPPedia_Vendor\\wpcom_vip_attachment_url_to_postid') ? wpcom_vip_attachment_url_to_postid($url) : self::url_to_postid($url);
        return absint($id);
    }
    /**
