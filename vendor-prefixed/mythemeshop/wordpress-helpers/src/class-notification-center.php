 ...
 */
namespace WPPedia_Vendor\MyThemeShop;
...
class Notification_Center
{
     ...
     * @var array
     */
    private $should_clear_storage = \true;
    /**
    ...
    public function get_from_storage()
    {
        ...
        if (\is_array($notifications)) {
            foreach ($notifications as $notification) {
                $this->notifications[] = new Notification($notification['message'], $notification['options']);
            }
        }
    }
    /**
    ...
    public function display()
    {
        ...
        foreach ($notifications as $notification) {
            if ($notification->can_display() && !\in_array((string) $notification, $this->displayed_notifications, \true)) {
                echo $notification;
    ...
    public function add($message, $options = [])
    {
        ...
        $this->notifications[] = new Notification($message, $options);
    }
    /**
    ...
    {
        return \function_exists('WPPedia_Vendor\\is_network_admin') && is_network_admin();
    }
    /**
