...
trait Select
{
     ...
     * @return self The current query builder.
     */
    public function selectCount($field = '*', $alias = null)
    {
     ...
     * @return self The current query builder.
     */
    public function selectSum($field, $alias = null)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function selectAvg($field, $alias = null)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function selectFunc($func, $field, $alias = null)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function distinct($distinct = \true)
    {
     ...
     * @return self The current query builder.
     */
    public function found_rows($found_rows = \true)
    {
