...
class Query_Builder
{
    ...
    {
        global $wpdb;
        $limit = \WPPedia_Vendor\absint($limit);
        $offset = \WPPedia_Vendor\absint($offset);
    ...
    {
        $size = \WPPedia_Vendor\absint($size);
        $offset = $size * \WPPedia_Vendor\absint($page);
    ...
    private function reset()
    {
        ...
        $this->sql_clauses = array('select' => array(), 'from' => array(), 'left_join' => array(), 'join' => array(), 'right_join' => array(), 'where' => array(), 'where_time' => array(), 'group_by' => array(), 'having' => array(), 'limit' => array(), 'order_by' => array(), 'values' => array());
        return $this;
    }
}
