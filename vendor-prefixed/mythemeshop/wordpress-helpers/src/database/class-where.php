 ...
 */
namespace WPPedia_Vendor\MyThemeShop\Database;
...
trait Where
{
     ...
     * @return self The current query builder.
     */
    public function whereIn($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereIn($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function whereNotIn($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereNotIn($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function whereBetween($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereBetween($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function whereNotBetween($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereNotBetween($column, $options)
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function whereLike($column, $value, $start = '%', $end = '%')
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereLike($column, $value, $start = '%', $end = '%')
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function whereNotLike($column, $value, $start = '%', $end = '%')
    {
        // @codingStandardsIgnoreLine
     ...
     * @return self The current query builder.
     */
    public function orWhereNotLike($column, $value, $start = '%', $end = '%')
    {
        // @codingStandardsIgnoreLine
     ...
     * @return string
     */
    protected function generateWhere($column, $param1 = null, $param2 = null, $type = 'AND')
    {
        // @codingStandardsIgnoreLine
        ...
        if (\is_array($param2)) {
            ...
            $param2 = \in_array($param1, array('BETWEEN', 'NOT BETWEEN'), \true) ? \join(' AND ', $param2) : '(' . \join(', ', $param2) . ')';
    ...
    {
        if (!\in_array($type, array('AND', 'OR', 'WHERE'), \true)) {
    ...
    private function bulk_where($where, $type, $sub_type)
    {
        ...
        $this->add_sql_clause('where', $type . ' ( ' . \trim(\join(' ', $subquery)) . ' )');
    }
}
